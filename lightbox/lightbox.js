...
var anchors=document.getElementsByTagName("a");for(var i=0;i<anchors.length;i++){var anchor=anchors[i];if(anchor.getAttribute("href")&&(anchor.getAttribute("rel")=="lightbox")){document.getElementById("autor").innerHTML =anchor.getAttribute("title");anchor.onclick=function(){showLightbox(this);return false;}}}
